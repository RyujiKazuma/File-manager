...
namespace ConsoleApp2
{
	class Program
	{
		...
		static string chosenOpt(char option, string cesta, int counter, int deletecount)
		{
			...
			{
				Console.WriteLine("Name the dir.(max 20 characters)");
				string myStr = "";
				do
				{
					...
					myStr += c;
				} while (myStr.Length <= 20);
				Directory.CreateDirectory(cesta + @"\" + myStr);
			}
			else if (option == '0')
			{
